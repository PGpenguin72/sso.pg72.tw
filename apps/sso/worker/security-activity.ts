...
export const SELF_ACTIVITY_SUMMARIES: Readonly<Record<string, string>> = {
  ...
  "recovery.codes_issued": "建立新的帳號復原碼",
  "recovery.codes_revoked": "撤銷帳號復原碼",
  "recovery.started": "使用復原碼開始帳號復原",
  "recovery.passkey_failed": "帳號復原 Passkey 驗證失敗",
  "recovery.completed": "完成帳號復原並撤銷所有工作階段",
