...
test("completed continuity evidence requires a populated migration-ledger summary", () => {
  ...
  for (const migrationLedger of [
    ...
    { count: 20, head: "0020_lookalike.sql", sha256: "b".repeat(64) },
    { count: 20, head: "not-a-migration", sha256: "b".repeat(64) },
    { count: 20, head: "0020_alert_observability.sql", sha256: "0" },
  ]) {
    assert.throws(() =>
